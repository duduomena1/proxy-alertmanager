...
def create_app():
    ...
    def alert_hetrix():
        try:
            ...
            monitor_name = data.get('monitor_name') or 'Monitor não identificado'
            ...
            severity_config = SEVERITY_LEVELS.get(severity_key, SEVERITY_LEVELS.get('hetrix_default'))
            ...
            content = (
                f"{severity_config['emoji']} **ALERTA HETRIX** - `{monitor_name}`\n\n"
